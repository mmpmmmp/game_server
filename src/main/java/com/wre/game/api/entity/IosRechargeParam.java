...
public class IosRechargeParam {
    ...
    private List<IosRechargeInApp> in_app=new ArrayList<>();
    private Map<String,IosRechargeInApp> in_app_map=new HashMap<>();

    /**转换一下*/
    public  void ListToMap(){
        if(this.in_app!=null&&!this.in_app.isEmpty()){
            for(IosRechargeInApp app:this.in_app){
                if(!StringUtils.isBlank(app.getTransaction_id())){
                    this.in_app_map.put(app.getTransaction_id(),app);
                }
            }
        }
    }
    ...
    public String toString() {
        return "IosRechargeParam{" +
                ...
                ", in_app=" + in_app +
                ", in_app_map=" + in_app_map +
                '}';
    }

    public Map<String, IosRechargeInApp> getIn_app_map() {
        return in_app_map;
    }

    public void setIn_app_map(Map<String, IosRechargeInApp> in_app_map) {
        this.in_app_map = in_app_map;
    }
    ...
    public List<IosRechargeInApp> getIn_app() {
        return in_app;
    }

    public void setIn_app(List<IosRechargeInApp> in_app) {
        this.in_app = in_app;
    }
}
